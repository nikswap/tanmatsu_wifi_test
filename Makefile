...
IDF_BRANCH ?= master
IDF_COMMIT ?= 8c750b088c7cd857d079c0eeb495da199b359461
IDF_EXPORT_QUIET ?= 1
...
.PHONY: install
install:
	cd badgelink/tools; ./badgelink.sh appfs upload application "wifi test app" 0 ../../build/tanmatsu/application.bin
